...
def train(cfg, output_dir='', run_name=''):
    ...
    LAMBDA_ADV_MAIN = 0.001
    # interpolate output segmaps:e.g. INPUT_SIZE_SOURCE = (1280, 720)
    ...
    for iteration in range(start_iteration, max_iteration):
        ...
        # adversarial training ot fool the discriminator with target samples   preds_2d = model_2d(data_batch_trg)
        for param in d_main.parameters():
